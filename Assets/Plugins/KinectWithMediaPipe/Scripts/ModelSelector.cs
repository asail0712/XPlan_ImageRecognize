    ...
    {        
        ...
        void Update()
        {
            ...
            if (selModel != null)
            {
                ...
                {
                    AvatarControllerWithMP ac = selModel.GetComponent<AvatarControllerWithMP>();
                    if (ac != null)
                    {
                        ac.bKinectMoving = !ac.bKinectMoving;
                    }
        ...
        private void LoadDressingModel(string modelDir)
        {
            ...
            if (ac == null)
            {
                ac = selModel.AddComponent<AvatarControllerWithMP>();
